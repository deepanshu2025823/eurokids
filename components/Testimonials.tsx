...
export default function Testimonials() {
  return (
    <section className="w-full py-16 md:py-24 bg-white relative overflow-hidden border-t border-gray-50">
      
      <div className="max-w-7xl mx-auto relative z-10 px-4 lg:px-8">
        
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-[#183385] text-2xl sm:text-3xl md:text-4xl lg:text-[40px] font-extrabold flex flex-wrap items-center justify-center gap-2 md:gap-3 leading-snug">
      ...
      <div className="w-full">
        <div className="flex overflow-x-auto snap-x snap-mandatory lg:grid lg:grid-cols-3 gap-6 lg:gap-8 pb-10 md:pb-0 scrollbar-hide px-5 lg:px-8 max-w-7xl mx-auto">
          
          {testimonialsData.map((testimonial, index) => (
            <article 
              key={index} 
              className={`${testimonial.bgColor} p-8 md:p-10 rounded-[32px] shadow-sm hover:shadow-xl transition-all duration-300 w-[88vw] sm:w-[350px] lg:w-auto snap-center shrink-0 flex flex-col relative group border border-transparent hover:border-white/50`}
            >
              ...
              <p className="text-gray-700 text-[15px] md:text-base leading-relaxed font-medium mb-8 flex-1 italic">
                "{testimonial.review}"
              </p>
