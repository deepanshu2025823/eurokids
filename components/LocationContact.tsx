      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="space-y-6 md:space-y-8 w-full max-w-xl mx-auto lg:mx-0">
            ...
            <div className="flex gap-4 pt-4 ml-[76px] md:ml-[0px]">
              
              <a href="#" aria-label="Facebook" className="w-11 h-11 bg-[#253b80] hover:bg-[#1877F2] text-white rounded-lg flex items-center justify-center transition-all duration-300 shadow-md hover:-translate-y-1">
              ...
              <a href="https://www.instagram.com/eurokidsec86summerpalm" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-11 h-11 bg-[#253b80] hover:bg-[#E1306C] text-white rounded-lg flex items-center justify-center transition-all duration-300 shadow-md hover:-translate-y-1">
              ...
              <a href="#" aria-label="LinkedIn" className="w-11 h-11 bg-[#253b80] hover:bg-[#0077B5] text-white rounded-lg flex items-center justify-center transition-all duration-300 shadow-md hover:-translate-y-1">
